...
import webreport.Person;
import webreport.SynchronizedClass;
...
//                    .forEach(x-> System.out.println(x));
    ...
    public void dateTimeTest(){
        ...
        LocalDateTime localDateTime2 = LocalDateTime.parse("2019-08-22 00:00:00",DateTimeFormatter.ofPattern("yyyy-MM-dd HH:mm:ss"));
        //把小时改为指定小时
        LocalDateTime localDateTime3 = LocalDateTime.parse("2019-08-15 14:00:00",DateTimeFormatter.ofPattern("yyyy-MM-dd HH:mm:ss"));
        //计算两个时间差
